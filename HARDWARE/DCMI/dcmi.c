...
{
    if(DMA_GetITStatus(DMA2_Stream1, DMA_IT_TCIF1) == SET)   //传输完成中断
    {
...
void DCMI_DMA_Double_Init(u32 Buffer0,u32 Buffer1,u16 DMA_BufferSize)
{
    ...
    DMA_InitStructure.DMA_Memory0BaseAddr = Buffer0;//DMA 存储器0地址
    ...
    DMA_Init(DMA2_Stream1, &DMA_InitStructure);//初始化DMA Stream
		...
		DMA_DoubleBufferModeConfig(DMA2_Stream1, Buffer1, DMA_Memory_1);
